...
func (mr *MockExecuterMockRecorder) ExecuteWithContext(ctx, command interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, command}, args...)
...
func (mr *MockExecuterMockRecorder) LookPath(file interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
