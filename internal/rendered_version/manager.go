...
var RenderedVersionManager util.Singleton[Manager]
...
func (m *Manager) WaitForNewRenderedVersion(ctx context.Context, orgId uuid.UUID, name string, knownRenderedVersion string) (bool, string, error) {
...
func (m *Manager) Store(ctx context.Context, orgId uuid.UUID, name string, renderedVersion string) error {
	if name == "" {
