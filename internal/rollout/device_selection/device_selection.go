...
func NewRolloutDeviceSelector(deviceSelection *v1alpha1.RolloutDeviceSelection, store store.Store, orgId uuid.UUID, fleet *v1alpha1.Fleet, templateVersionName string) (RolloutDeviceSelector, error) {
	...
	case v1alpha1.BatchSequence:
		return newBatchSequenceSelector(v, store, orgId, fleet, templateVersionName), nil
	default:
