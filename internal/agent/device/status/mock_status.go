...
func (mr *MockExporterMockRecorder) Export(ctx, device interface{}) *gomock.Call {
...
func (mr *MockExporterMockRecorder) SetProperties(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCollectorMockRecorder) Get(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagerMockRecorder) SetClient(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// SetProperties indicates an expected call of SetProperties.
func (mr *MockManagerMockRecorder) SetProperties(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagerMockRecorder) UpdateCondition(ctx, conditionType, conditionStatus, reason, message interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagerMockRecorder) UpdateConditionError(ctx, reason, err interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
